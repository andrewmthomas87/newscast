...
export const JobType = {
  ...
  generateCombinedBroadcast: 'generateCombinedBroadcast'
} as const;
...
export const JobPayloadSchema = {
  ...
  generateTransitions: z.object({ broadcastID: z.number() }),
  generateBroadcastAudio: z.object({ broadcastID: z.number() }),
  generateCombinedBroadcast: z.object({ broadcastID: z.number() }),
